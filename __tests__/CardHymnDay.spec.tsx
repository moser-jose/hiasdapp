...
//jest.mock("@/helpers/getDailyHymn");
...
describe("CardHymnDay", () => {
  ...
  it("should render loading state initially", async () => {
    const { UNSAFE_getByType } = render(<CardHymnDay hymns={hymnsWithArtwork} categories={categoriesTest} />)
  ...
  it("should render the hymn of the day after loading", async () => {
    ...
    const { UNSAFE_queryByType } = render(<CardHymnDay hymns={hymnsWithArtwork} categories={categoriesTest} />);
  ...
  it("should display truncated category name if too long", async () => {
    ...
    const { UNSAFE_queryByType } = render(<CardHymnDay hymns={[hymnWithLongCategory]} categories={[categoriesTest[0]]} />);
