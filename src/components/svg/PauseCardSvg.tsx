...
const PauseCardSVG: React.FC<SVGIconProps> =  ({color, width, height}) =>{
  return (
    <Svg width={width ?? "45"}  height={height ?? "45"} viewBox='0 0 24 24' fill={color}>
      ...
      <Path fillRule="evenodd" clipRule="evenodd" d="M2 12C2 6.47979 6.48 2 12 2C17.52 2 22 6.47979 22 12C22 17.5202 17.52 22 12 22C6.48 22 2 17.5202 2 12ZM9 8H10.5V16H9V8ZM15 8H13.5V16H15V8Z" fill={color}/>
